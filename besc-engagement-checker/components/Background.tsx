export default function Background() {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-void">
      ...
      <div className="absolute left-1/2 top-[-20%] h-[70vh] w-[70vh] -translate-x-1/2 animate-aurora rounded-full bg-besc-500/25 blur-[140px]" />
      <div className="absolute right-[-10%] top-[10%] h-[50vh] w-[50vh] animate-aurora rounded-full bg-signal/20 blur-[140px] [animation-delay:-8s]" />
